...
const DIMENSIONS: RuntimeDimensionDefinition[] = [
  ...
  },
  {
    ...
    name: 'The End',
    emoji: '🌌',
    description: 'Rings of thick islands around a central obsidian platform, under a purple/pink sky that falls into a black-hole void.',
    sky: new Color4(0.55, 0.2, 0.65, 1),
    fog: new Color3(0.35, 0.15, 0.5),
    gravity: new Vector3(0, -0.32, 0),
    tint: new Color3(0.9, 0.4, 1.0),
    weather: 'Purple-pink void, gravitational lensing',
    ...
    lore: 'An endless galaxy of island rings around a central dragon platform, caught inside a black hole that only ever pulls you deeper.',
