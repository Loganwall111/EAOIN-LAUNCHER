...
const BOSSES: BossDef[] = [
  ...
  { id: 'the_creator', name: 'The Creator', emoji: '👴', dimension: 'cosmic_void', description: 'The mysterious architect of reality. Manipulates the source code of the world.', tier: 'final', health: 10000, damage: 100, abilities: ['Reality Warp', 'Terrain Rearrange', 'Echo Summon', 'Source Code Particles'], phases: 5, arena: 'The Corrupted Lands', musicTrack: 'The Creator Theme', drops: ['Final Truth', 'Rocket Launch Access'], lore: 'A figure with a large mustache wearing ancient robes. He rewrite parts of the battlefield in real time.', size: { width: 1.0, height: 2.0, depth: 1.0 }, color: '#ffffff' },
];
