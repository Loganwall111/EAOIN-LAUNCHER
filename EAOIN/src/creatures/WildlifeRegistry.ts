...
const OCEAN: SpeciesDefinition[] = [
  ...
  {
    id: 'giggle_sprite', name: 'Giggle Sprite', emoji: '🧚', bodyPlan: 'biped', habitat: 'air', temperament: 'passive',
    palette: { body: '#ffd86a', head: '#ffe9a8', limb: '#e0a83a', accent: '#fff0c0' },
    scale: 0.5, health: 8, speed: 2.6, damage: 0,
    biomes: ['humorous', 'void'], weight: 8, nocturnal: false,
    loot: [{ blockId: 301, amount: 1 }],
    description: 'A giggling wisp of light that giggles the moment you look at it.',
  },
  {
    id: 'pun_golem', name: 'Pun Golem', emoji: '🗿', bodyPlan: 'quadruped', habitat: 'land', temperament: 'neutral',
    palette: { body: '#8a7a5a', head: '#a08a60', limb: '#6a5a3a', accent: '#d8c878' },
    scale: 1.6, health: 70, speed: 0.7, damage: 10,
    biomes: ['humorous', 'void'], weight: 5, nocturnal: false,
    loot: [{ blockId: 57, amount: 3 }],
    description: 'A walking statue that only tells terrible puns. Do not roll your eyes too hard.',
  },
  {
    id: 'jesting_frog', name: 'Jesting Frog', emoji: '🐸', bodyPlan: 'biped', habitat: 'amphibious', temperament: 'neutral',
    palette: { body: '#5aa84a', head: '#7ac86a', limb: '#3a7a34', accent: '#c8f0a8' },
    scale: 0.7, health: 14, speed: 1.4, damage: 2,
    biomes: ['humorous', 'void'], weight: 8, nocturnal: false,
    loot: [{ blockId: 304, amount: 1 }],
    description: 'Leaps between ponds, ribbiting punchlines nobody asked for.',
  },
  {
    id: 'chorus_wisp', name: 'Chorus Wisp', emoji: '💫', bodyPlan: 'bird', habitat: 'air', temperament: 'neutral',
    palette: { body: '#6ae0d8', head: '#9af0e8', limb: '#3aa8a0', accent: '#d8fff8' },
    scale: 0.6, health: 16, speed: 2.2, damage: 4,
    biomes: ['humorous', 'void'], weight: 6, nocturnal: false,
    loot: [{ blockId: 307, amount: 1 }],
    description: 'A humming wisp of Chorus that rings like a bell and chimes when it bumps you.',
  },
  {
...
const EAOIN_NATIVES: SpeciesDefinition[] = [
  ...
  /* Deeper Nether — crimson & warped forest fauna, Minecraft-inspired. */
  {
    id: 'crimson_hoglin', name: 'Crimson Hoglin', emoji: '🐗', bodyPlan: 'quadruped', habitat: 'land', temperament: 'hostile',
    palette: { body: '#b8304a', head: '#e04060', limb: '#6a1a28', accent: '#ffd166' },
    scale: 1.4, health: 80, speed: 1.6, damage: 14,
    biomes: ['crimson', 'crimson_forest', 'nether'], weight: 9,
    loot: [{ blockId: 55, amount: 2 }],
    description: 'A boar of the crimson forest with a hot temper.',
  },
  {
    id: 'warped_strider', name: 'Warped Strider', emoji: '🦵', bodyPlan: 'quadruped', habitat: 'land', temperament: 'neutral',
    palette: { body: '#b06a4a', head: '#c8805c', limb: '#8a4a30', accent: '#7ae0f8' },
    scale: 1.1, health: 46, speed: 1.3, damage: 6,
    biomes: ['warped', 'warped_forest', 'nether'], weight: 8,
    loot: [{ blockId: 56, amount: 1 }],
    description: 'It saunters across the lava without a care.',
  },
  {
    id: 'nether_ghast', name: 'Nether Ghast', emoji: '👻', bodyPlan: 'insect', habitat: 'air', temperament: 'hostile',
    palette: { body: '#f2e8d8', head: '#ffffff', limb: '#c8b8a8', accent: '#ff8c8c' },
    scale: 1.6, health: 60, speed: 1.1, damage: 12,
    biomes: ['nether', 'crimson', 'warped', 'basalt', 'soul'], weight: 5,
    loot: [{ blockId: 8, amount: 2 }],
    description: 'It drifts on the hot air and howls fire across the wastes.',
  },
  {
    id: 'blaze', name: 'Blaze', emoji: '🔥', bodyPlan: 'biped', habitat: 'air', temperament: 'hostile',
    palette: { body: '#f2c040', head: '#ffe680', limb: '#b88020', accent: '#ff4d4d' },
    scale: 0.9, health: 40, speed: 1.7, damage: 11,
    biomes: ['nether', 'basalt', 'volcanic', 'soul'], weight: 7,
    loot: [{ blockId: 8, amount: 1 }],
    description: 'A living furnace of floating fire, always charging.',
  },
  {
    id: 'magma_cube', name: 'Magma Cube', emoji: '🟧', bodyPlan: 'serpent', habitat: 'land', temperament: 'hostile',
    palette: { body: '#d85820', head: '#c84818', limb: '#8a2a10', accent: '#ffd166' },
    scale: 1.0, health: 52, speed: 0.9, damage: 10,
    biomes: ['nether', 'basalt', 'volcanic'], weight: 8,
    loot: [{ blockId: 219, amount: 2 }],
    description: 'It splits and squirms and leaves bright embers behind.',
  },
  {
    id: 'wither_skeleton', name: 'Wither Skeleton', emoji: '💀', bodyPlan: 'biped', habitat: 'land', temperament: 'hostile',
    palette: { body: '#3a3a3d', head: '#4a4a4d', limb: '#222224', accent: '#ff6a2a' },
    scale: 1.3, health: 70, speed: 1.2, damage: 15,
    biomes: ['nether', 'soul', 'basalt'], weight: 6,
    loot: [{ blockId: 128, amount: 1 }],
    description: 'Charred bones that never stopped marching.',
  },
  {
    id: 'piglin', name: 'Piglin', emoji: '🐷', bodyPlan: 'biped', habitat: 'land', temperament: 'neutral',
    palette: { body: '#e8a080', head: '#f0b088', limb: '#b06848', accent: '#ffd166' },
    scale: 1.0, health: 40, speed: 1.5, damage: 8,
    biomes: ['crimson', 'crimson_forest', 'nether'], weight: 8,
    loot: [{ blockId: 67, amount: 1 }],
    description: 'It eyes your trinkets. Back slowly.',
  },
  {
    id: 'zombified_piglin', name: 'Zombified Piglin', emoji: '🧟', bodyPlan: 'biped', habitat: 'land', temperament: 'hostile',
    palette: { body: '#7a9a6a', head: '#86a676', limb: '#4a6a3a', accent: '#cfe8c8' },
    scale: 1.0, health: 44, speed: 1.4, damage: 10,
    biomes: ['warped', 'warped_forest', 'nether'], weight: 7,
    loot: [{ blockId: 67, amount: 1 }],
    description: 'It does not remember what it used to be.',
  },
  {
    id: 'warped_enderman', name: 'Warped Enderman', emoji: '🚶', bodyPlan: 'biped', habitat: 'land', temperament: 'hostile',
    palette: { body: '#181024', head: '#1a1030', limb: '#0c0818', accent: '#7ae0f8' },
    scale: 1.5, health: 64, speed: 2.0, damage: 12,
    biomes: ['warped', 'warped_forest'], weight: 4,
    loot: [{ blockId: 16, amount: 1 }],
    description: 'It un-twists out of the warp when you are not looking.',
  },
  {
    id: 'crimson_fungling', name: 'Crimson Fungling', emoji: '🍄', bodyPlan: 'quadruped', habitat: 'land', temperament: 'passive',
    palette: { body: '#a83a4a', head: '#d05060', limb: '#5a1a24', accent: '#ffb0c0' },
    scale: 0.6, health: 12, speed: 1.0, damage: 0,
    biomes: ['crimson', 'crimson_forest', 'nether'], weight: 10,
    loot: [{ blockId: 55, amount: 1 }],
    description: 'A shy little spore-calf of the crimson woods.',
  },
  {
    id: 'warped_fungling', name: 'Warped Fungling', emoji: '🍄', bodyPlan: 'quadruped', habitat: 'land', temperament: 'passive',
    palette: { body: '#2a9a9a', head: '#38c0c0', limb: '#145a5a', accent: '#b0fff0' },
    scale: 0.6, health: 12, speed: 1.0, damage: 0,
    biomes: ['warped', 'warped_forest', 'nether'], weight: 10,
    loot: [{ blockId: 56, amount: 1 }],
    description: 'A little blue spore-calf glowing in the warp.',
  },
