...
export const BLOCKS: Record<BlockID, BlockDef> = {
  ...
  /* ---------- 345..370 — farming & food overhaul (2.0) ---------- */
  345: { id: 345, name: 'Wheat Seeds', shortName: 'WS', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#d8c86a', accentColor: '#8a7a2a' },
  346: { id: 346, name: 'Wheat Sprout', shortName: 'WS', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#7ec850', accentColor: '#4a8a2a' },
  347: { id: 347, name: 'Wheat Plant', shortName: 'WP', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#9ad06a', accentColor: '#5aaa3a' },
  348: { id: 348, name: 'Wheat (Mature)', shortName: 'WH', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#e8d86a', accentColor: '#a88a2a' },
  349: { id: 349, name: 'Wheat', shortName: 'WH', category: 'food', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#e0c860', accentColor: '#a8902a' },
  350: { id: 350, name: 'Carrot Seeds', shortName: 'CS', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#c8a058', accentColor: '#7a5020' },
  351: { id: 351, name: 'Carrot Sprout', shortName: 'CS', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#7ec850', accentColor: '#4a8a2a' },
  352: { id: 352, name: 'Carrot Plant', shortName: 'CP', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#e88a4a', accentColor: '#a85a20' },
  353: { id: 353, name: 'Carrot (Mature)', shortName: 'CR', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#e87a2a', accentColor: '#a85010' },
  354: { id: 354, name: 'Potato Seed', shortName: 'PS', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#b8a878', accentColor: '#78684a' },
  355: { id: 355, name: 'Potato Sprout', shortName: 'PS', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#8ac85a', accentColor: '#5a8a2a' },
  356: { id: 356, name: 'Potato Plant', shortName: 'PP', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#6a9a5a', accentColor: '#4a6a3a' },
  357: { id: 357, name: 'Potato (Mature)', shortName: 'PO', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#c8b070', accentColor: '#8a7030' },
  358: { id: 358, name: 'Tomato Seeds', shortName: 'TS', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#d8c868', accentColor: '#8a7820' },
  359: { id: 359, name: 'Tomato Sprout', shortName: 'TS', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#7ec850', accentColor: '#4a8a2a' },
  360: { id: 360, name: 'Tomato Plant', shortName: 'TP', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#8a9a3a', accentColor: '#5a6a2a' },
  361: { id: 361, name: 'Tomato (Mature)', shortName: 'TM', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#e8503a', accentColor: '#a82810' },
  362: { id: 362, name: 'Tomato', shortName: 'TO', category: 'food', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#e8503a', accentColor: '#a82810' },
  363: { id: 363, name: 'Pumpkin Seeds', shortName: 'PS', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#e8d8a0', accentColor: '#a09040' },
  364: { id: 364, name: 'Pumpkin Sprout', shortName: 'PS', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#8ac85a', accentColor: '#5a9a2a' },
  365: { id: 365, name: 'Pumpkin Vine', shortName: 'PV', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#6aaa4a', accentColor: '#4a7a2a' },
  366: { id: 366, name: 'Pumpkin (Mature)', shortName: 'PM', category: 'plant', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 64, color: '#e67a1a', accentColor: '#a85010' },
  367: { id: 367, name: 'Farmland (Moist)', shortName: 'FM', category: 'nature', solid: true, transparent: false, hardness: 0.6, lightLevel: 0, emissive: false, stackSize: 64, color: '#3a2410', accentColor: '#5a3a1c' },
  368: { id: 368, name: 'Tomato Soup', shortName: 'TS', category: 'food', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 1, color: '#c8503a', accentColor: '#e8a888' },
  369: { id: 369, name: 'Vegetable Stew', shortName: 'VS', category: 'food', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 1, color: '#a8683a', accentColor: '#e0b088' },
  370: { id: 370, name: 'Apple Pie', shortName: 'AP', category: 'food', solid: false, transparent: true, hardness: 0.0, lightLevel: 0, emissive: false, stackSize: 1, color: '#c88a3a', accentColor: '#e8c890' },
};
